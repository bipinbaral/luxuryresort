    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 md:px-12 pb-16 w-full">
          <p className="label mb-3" style={{ color: '#E6D2B5' }}>Dining</p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <Reveal delay={150}>
            <div className="img-hover" style={{ height: '440px', background: '#E6D2B5' }}>
              <img
      ...
      {/* Restaurants */}
      <section className="pb-24 px-6 md:px-12" style={{ background: '#FCFCFA' }}>
              ...
              <Reveal key={restaurant.name} delay={i * 80}>
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center ${i % 2 !== 0 ? 'md:[direction:rtl]' : ''}`}>
                  ...
                  <div className={i % 2 !== 0 ? 'md:[direction:ltr]' : ''}>
                    ...
                    <p className="leading-relaxed" style={{ fontSize: '15px', color: '#4F5B63', lineHeight: 1.85 }}>{restaurant.description}</p>
                    <div className="mt-8 flex flex-col gap-3">
                      <div className="flex gap-4 text-sm py-3 border-b" style={{ borderColor: 'rgba(217, 184, 140,0.2)' }}>
                        <span className="font-medium" style={{ color: '#8A7256', width: '80px', flexShrink: 0 }}>Hours</span>
                        <span style={{ color: '#061A2F' }}>{restaurant.hours}</span>
                      </div>
                      <div className="flex gap-4 text-sm py-3 border-b" style={{ borderColor: 'rgba(217, 184, 140,0.2)' }}>
                        <span className="font-medium" style={{ color: '#8A7256', width: '80px', flexShrink: 0 }}>Dress</span>
                        <span style={{ color: '#061A2F' }}>{restaurant.dress}</span>
                      </div>
                    </div>
      ...
      {/* Private dining */}
      <section className="py-20 px-6" style={{ background: '#061A2F' }}>
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={150}>
              <div className="img-hover" style={{ height: '400px', background: '#0A2239' }}>
                <img
